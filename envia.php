...
try {
     ...
     $mail->Username = 'contato@telapar.com.br'; // Usuário do servidor SMTP (endereço de email)
     $mail->Password = 'eneasnova@19'; // Senha do servidor SMTP (senha do email usado)
$mail->AddAddress('contato@telapar.com.br', 'Estrutura Metalica PR');
     //Define o remetente
     // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=    
     $mail->SetFrom('contato@telapar.com.br', "$nomeremetente"); //Seu e-mail
     $mail->AddReplyTo('contato@telapar.com.br', 'Nome'); //Seu e-mail	
